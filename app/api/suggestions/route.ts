...
Task:
1. Select the most appropriate Category ID from the available list based on the SMS text and past habits.
2. Generate a short, crisp label/note (max 4 words) describing the transaction (e.g. "Swiggy Order", "Uber Ride", "Netflix Subscription").
